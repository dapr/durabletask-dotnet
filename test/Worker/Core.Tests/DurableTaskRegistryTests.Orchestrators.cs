...
public partial class DurableTaskRegistryTests
{
    ...
    {
        RunAddOrchestratorTest(r =>
            r.AddOrchestratorFunc(nameof(TestOrchestrator), (TaskOrchestrationContext ctx, string input) => input));
    }
    ...
    {
        RunAddOrchestratorTest(r =>
            r.AddOrchestratorFunc(nameof(TestOrchestrator), (TaskOrchestrationContext ctx) => Task.CompletedTask));
    }
    ...
    {
        RunAddOrchestratorTest(r =>
            r.AddOrchestratorFunc(nameof(TestOrchestrator), (TaskOrchestrationContext ctx) => string.Empty));
    }
    ...
    {
        RunAddOrchestratorTest(r =>
            r.AddOrchestratorFunc(nameof(TestOrchestrator), (TaskOrchestrationContext ctx, string input) => { }));
    }
    ...
    {
        RunAddOrchestratorTest(r =>
            r.AddOrchestratorFunc(nameof(TestOrchestrator), (TaskOrchestrationContext ctx) => { }));
    }
