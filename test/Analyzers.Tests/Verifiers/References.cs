...
public static class References
{
    ...
    public static ReferenceAssemblies CommonAssemblies
    {
        get
        {
            return durableAssemblyReferences.Value;
        }
    }

    static ReferenceAssemblies BuildReferenceAssemblies()
    {
        return ReferenceAssemblies.Net.Net60.AddPackages(new ImmutableArray<PackageIdentity>
        {
